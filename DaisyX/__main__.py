...
PM_START_TEXT = """
Hello there, I'm [𝓒𝓛𝓔𝓥𝓔𝓡 𝓑𝓞𝓨](https://telegra.ph/file/c21a37a9866e9316cbf54.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add clever boy to your group 💫", url="t.me/daisyXBot?startgroup=true"
        ),
    ],
]
...
Support them  [Lasiyahh](t.me/Lasiyahh),[Jason](t.me/imjanindu),"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Cleverboy.modules." + module_name)
